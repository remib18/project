...
export class InfiniteScrollManager {
    ...
    constructor({
        ...
        // Allowing to track endpoints with different versions
    ...
    deactivate() {
        ...
        // Increment version to ignore any in-flight requests
        this.requestVersion++;
    }
     ...
     * @param newEndpoint {string} - The new endpoint
     */
    updateEndpoint(newEndpoint) {
        this.apiEndpoint = newEndpoint;
        this.requestVersion++;
        this._reset(); // Reset state when endpoint changes
    }
    ...
    async _fetchPage() {
        ...
        try {
            ...
            // Check if this response is for the current version
            ...
            // Double-check version again before rendering
            if (currentVersion !== this.requestVersion) {
                console.log('Ignoring results from outdated request');
                return;
            }
